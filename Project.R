...
# time_index <- seq(from = as.POSIXct("2004-01-01 00:00",tz="EST"),to = as.POSIXct("2017-12-31 23:00",tz="EST"), by = "hour")
...
require(xts)
require(forecast)
projectData<-read.csv("input_data_team_9.csv", header = TRUE)
